...
%prep
%setup -q -n zict-2.1.0
cd %{_builddir}/zict-2.1.0
...
cp %{_builddir}/zict-2.1.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-zict/e4e3a49b903643223d20583fc15b06778c418ff9
